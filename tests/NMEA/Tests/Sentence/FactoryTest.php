...
//
    public function testRMC()
    {
        ...
        $str = '$GPRMC,081836,A,3751.65,S,14507.36,E,000.0,360.0,130998,011.3,E*62';
        $str = '$GPRMC,225446,A,4916.45,N,12311.12,W,000.5,054.7,191194,020.3,E*68';
        $str = '$GPRMC,220516,A,5133.82,N,00042.24,W,173.8,231.8,130694,004.2,W*70';
        $factory = new Sentence\Factory();
        $sentence = $factory->create($str);
...
//        $str = '$GPGLL,4916.45,N,12311.12,W,225444,A,*1D';
 //       $str = '$GPGLL,3751.65,S,14507.36,E*77';
        $str = '$GPGLL,4916.45,N,12311.12,W,225444,A';
        $factory = new Sentence\Factory();
        $sentence = $factory->create($str);
